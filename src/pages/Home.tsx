          ...
          <div className="space-y-12">
            ...
            <ol className="list-decimal list-outside pl-6 space-y-3">
              ...
              <WorkingPaperItem
                ...
                slidesUrl="/slides/AntidumpingPolitical.pdf"
                abstract="Do free trade agreements raise or lower antidumping protection against non-members? We develop a trade model in which the answer depends on political affinity between FTA partners. When partners are politically close, governments internalize each other's export interests and raise external antidumping duties—a stumbling block effect. When affinity is low, standard tariff complementarity dominates and FTAs reduce external protection. The model further predicts that import demand elasticity modulates this heterogeneity: stumbling blocks arise where protection is costly (high elasticity), while building blocks dominate where it is cheap. Using bilateral antidumping data spanning 30 countries and 26 years (1990–2015), we find strong support for the elasticity-dependent heterogeneity and provide a unified explanation for the conflicting results in the prior literature."
              />
              <WorkingPaperItem
